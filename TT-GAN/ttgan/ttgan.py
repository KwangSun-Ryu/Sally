...
class TTGAN(BaseSynthesizer):
    ...
    This is the core class of the TTGAN project, where the different components
    ...
    def fit(self, train_data, discrete_columns=(), epochs=None):
        ...
        for i in epoch_iterator:
            ...
            torch.save(self._generator.state_dict(), f"{self._checkpoint}/checkpoint_{self._target}_{i + 1}.pt")
